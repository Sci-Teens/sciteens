    ...
    <div>
      ...
      <main className="">
        ...
        <div className="mb-48 bg-backgroundGreen">
          <h2 className="ml-24 text-4xl font-semibold max-w-2xl mb-12">SciTeens takes pride in its open source and collaborative platform, but let our users do the talking for us.</h2>
          <div className="relative flex flex-row justify-between mx-24 z-10">
            ...
            <div className="bg-white shadow rounded-lg w-[30%]">
              <p className="text-3xl">NEED 1 MORE TESTIMONIAL</p>
            </div>
          </div>
          <svg className="-mt-44" viewBox="0 0 960 75" width="full" height="full" xmlns="http://www.w3.org/2000/svg" version="1.1">
            ...
            76C320 76 280 76 240 76C200 76 160 76 120 76C80 76 40 76 20 76L0 76Z" fill="#2D8A5B" stroke-linecap="round"
          ...
          <svg viewBox="0 0 960 75" width="full" height="full" xmlns="http://www.w3.org/2000/svg" version="1.1">
            ...
            360 0C320 0 280 0 240 0C200 0 160 0 120 0C80 0 40 0 20 0L0 0Z" fill="#2D8A5B" stroke-linecap="round"
              stroke-linejoin="miter">
            </path>
          </svg>
        </div>
