        ...
        <div className="flex flex-row justify-evenly py-8">
          ...
          <div className="mx-8 md:mx-12 lg:mx-0 lg:w-2/3">
            ...
            <p className="text-muted-foreground mb-10">
              ...
              community at SciTeens Inc., doing business as
              ...
              explain to you in the clearest way possible
              what information we collect, how we use it and
              what rights you have in relation to it. We
              hope you take some time to read through it
              carefully, as it is important. If there are
              any terms in this privacy policy that you do
            ...
            {/* Privacy 1 */}
            <div>
              <h2 id="privacy1" className="mb-2 text-2xl">
                WHAT INFORMATION DO WE COLLECT?
              </h2>
              ...
              <p className="text-muted-foreground mb-6">
                ...
                that you provide to us. We collect personal
                information that you voluntarily provide to
                us when registering at the Services
                expressing an interest in obtaining
                information about us or our products and
                services, when participating in activities
                on the Services (such as posting messages in
                our online forums or entering competitions,
                contests or giveaways) or otherwise
                contacting us. The personal information that
                we collect depends on the context of your
                interactions with us and the Services, the
                choices you make and the products and
                features you use. The personal information
                ...
                <br />
                We collect first name, maiden name, last
                name, and nickname; email addresses; and
                other similar data.
                <br />
                <b>Personal Information Provided by You.</b>
                <br />
                We collect passwords; and other similar
                data.
                <br />
                <b>Social Media Login Data.</b>
                <br />
                We may provide you with the option to
                register using social media account details,
              ...
              <p className="text-muted-foreground mb-6">
                ...
                when you visit our Services. We
                ...
                <br />
                We collect cookie identifiers, or others
                such as the ones used for analytics and
              ...
              <p className="text-muted-foreground mb-10">
                ...
                We may obtain information about your from
                other sources, such as public databases,
                joint marketing partners, social media
                platforms (such as Facebook), as well as
                from other third parties. Examples of the
                information we receive from other sources
                include: social media profile information
                (your name, gender, birthday, email, current
                city, state and country, user identification
                numbers for your contacts, profile picture
                URL, and any other information that you
                choose to make public); marketing leads and
                search results and links, including paid
                listings (such as sponsored links). We will
                inform you about the source of information
                and the type of information and the type of
            ...
            {/* Privacy 2 */}
            <div>
              <h2 id="privacy2" className="mb-2 text-2xl">
                HOW DO WE USE YOUR INFORMATION?
              </h2>
              <p className="text-muted-foreground mb-4">
                In Short: We process your information for
                purposes based on legitimate business
                interests, the fulfillment of our contract
                with you, compliance with our legal
                obligations, and/or your consent. We use
                personal information collected via our
                Services for a variety of business purposes
                described below. We process your personal
                information for these purposes in reliance
                on our legitimate business interests, in
                order to enter into or perform a contract
                with you, with your consent, and/or for
                compliance with our legal obligations. We
                indicate the specific processing grounds we
              ...
              <ul className="text-muted-foreground mb-10 ml-4 list-inside list-decimal">
                <li>
                  ...
                  process. If you choose to link your
                  account with us to a third party account
                  (such as your Google or Facebook account),
                  we use the information you allowed us to
                  collect from those third parties to
                ...
                <li>
                  ...
                  aggregated and anonymized form so that it
                  is not associated with individual end
                  users and does not include personal
                  information. We will not use identifiable
            ...
            {/* Privacy 3 */}
            <div>
              <h2 id="privacy3" className="mb-2 text-2xl">
                WILL YOUR INFORMATION BE SHARED WITH ANYONE?
              </h2>
              <p className="text-muted-foreground mb-4">
                In Short: We only share information with
                your consent, to comply with laws, to
                provide you with services, to protect your
                rights, or to fulfill business obligations.
                We may process or share data based on the
              ...
              <ul className="text-muted-foreground mb-4 ml-4 list-inside list-decimal">
                <li>
                  ...
                  personal information in a specific
                  purpose.
                </li>
                <li>
                ...
                <li>
                  ...
                  information where we are legally required
                  to do so in order to comply with
                ...
                <li>
                  ...
                  information where we believe it is
                  necessary to investigate, prevent, or take
                  action regarding potential violations of
                  our policies, suspected fraud, situations
                  involving potential threats to the safety
                  of any person and illegal activities, or
                  as evidence in litigation in which we are
                  involved.
                </li>
              </ul>
              <p className="text-muted-foreground mb-4">
                More specifically, we may need to process
                your data or share your personal information
                in the following situations:
              </p>
              <ul className="text-muted-foreground mb-10 ml-4 list-inside list-decimal">
                <li>
                  Vendors, Consultants and Other Third-Party
                  Service Providers. We may share your data
                  with third party vendors, service
                  providers, contractors or agents who
                  perform services for us or on our behalf
                  and require access to such information to
                  do that work. Examples include: payment
                  processing, data analysis, email delivery,
                  hosting services, customer service and
                  marketing efforts. We may allow selected
                  third parties to use tracking technology
                  on the Services, which will enable them to
                  collect data about how you interact with
                  the Services over time. This information
                  may be used to, among other things,
                  analyze and track data, determine the
                  popularity of certain content and better
                  understand online activity. Unless
                  described in this Policy, we do not share,
                  sell, rent or trade any of your
                  information with third parties for their
                  promotional purposes. We have contracts in
                  place with our data processors. This means
                  that they cannot do anything with your
                  personal information unless we have
                  instructed them to do it. They will not
                  share your personal information with any
                  organisation apart from us. They will hold
                  it securely and retain it for the period
                  we instruct.
                </li>
                <li>
                  ...
                  merger, sale of company assets, financing,
                  or acquisition of all or a portion of our
                  business to another company.
                </li>
                <li>
                  Other Users. When you share personal
                  information (for example, by posting
                  comments, contributions or other content
                  to the Services) or otherwise interact
                  with public areas of the Services, such
                  personal information may be viewed by all
                  users and may be publicly distributed
                  outside the Services in perpetuity. If you
                  interact with other users of our Services
                  and register through a social network
            ...
            {/* Privacy 4 */}
            <div>
              <h2 id="privacy4" className="mb-2 text-2xl">
                WHO WILL YOUR INFORMATION BE SHARED WITH?
              </h2>
              <p className="text-muted-foreground mb-4">
                In Short: We only share information with the
                following third parties. We only share and
                disclose your information with the following
                third parties. We have categorized each
                party so that you may be easily understand
                the purpose of our data collection and
                processing practices. If we have processed
                your data based on your consent and you wish
                to revoke your consent, please contact us.
              </p>
              <ul className="text-muted-foreground mb-10 ml-4 list-inside list-decimal">
                <li>
                  <b>
                    Allow Users to Connect to their
                ...
                <li>
                  ...
                  Cloud Firestore, Firebase Realtime
                  Database , Firebase Hosting and Cloud
            ...
            {/* Privacy 5 */}
            <div>
              <h2 id="privacy5" className="mb-2 text-2xl">
                DO WE USE COOKIES AND OTHER TRACKING
                TECHNOLOGIES?
              </h2>
              <p className="text-muted-foreground mb-10">
                ...
                your information. We may use cookies and
                similar tracking technologies (like web
                beacons and pixels) to access or store
                information. Specific information about how
                we use such technologies and how you can
            ...
            {/* Privacy 6 */}
            <div>
              <h2 id="privacy6" className="mb-2 text-2xl">
                DO WE USE GOOGLE MAPS?
              </h2>
              <p className="text-muted-foreground mb-10">
                In Short: Yes, we use Google Maps for the
                purpose of providing better service. This
                website, mobile application, or Facebook
                application uses Google Maps APIs. You may
                ...
                By using our Maps API Implementation, you
                agree to be bound by Google’s Terms of
                Service.
              </p>
            </div>
            ...
            {/* Privacy 7 */}
            <div>
              <h2 id="privacy7" className="mb-2 text-2xl">
                HOW DO WE HANDLE YOUR SOCIAL LOGINS?
              </h2>
              <p className="text-muted-foreground mb-10">
                In Short: If you choose to register or log
                in to our services using a social media
                account, we may have access to certain
                information about you. Our Services offer
                you the ability to register and login using
                your third party social media account
            ...
            {/* Privacy 8 */}
            <div>
              <h2 id="privacy8" className="mb-2 text-2xl">
                HOW LONG DO WE KEEP YOUR INFORMATION?
              </h2>
              <p className="text-muted-foreground mb-10">
                In Short: We keep your information for as
                long as necessary to fulfill the purposes
                outlined in this privacy policy unless
                otherwise required by law. We will only keep
                your personal information for as long as it
                is necessary for the purposes set out in
                this privacy policy, unless a longer
                retention period is required or permitted by
                law (such as tax, accounting or other legal
                requirements). No purpose in this policy
                will require us keeping your personal
                information for longer than the period of
            ...
            {/* Privacy 9 */}
            <div>
              <h2 id="privacy9" className="mb-2 text-2xl">
                HOW DO WE KEEP YOUR INFORMATION SAFE?
              </h2>
              <p className="text-muted-foreground mb-10">
                ...
                measures. We have implemented appropriate
                technical and organizational security
                measures designed to protect the security of
            ...
            {/* Privacy 10 */}
            <div>
              <h2 id="privacy10" className="mb-2 text-2xl">
                WHAT ARE YOUR PRIVACY RIGHTS?
              </h2>
              <p className="text-muted-foreground mb-4">
                In Short: You may review, change, or
                terminate your account at any time.If you
                are resident in the European Economic Area
              ...
              <ul className="text-muted-foreground mb-6 list-inside list-decimal">
                <li>
                  Log into your account settings and update
                  your user account.
                </li>
                <li>
              ...
              <p className="text-muted-foreground mb-10">
                ...
                However, some information may be retained in
                ...
                legal requirements. Cookies and similar
                technologies: Most Web browsers are set to
                accept cookies by default. If you prefer,
                you can usually choose to set your browser
                to remove cookies and to reject cookies. If
                you choose to remove cookies or reject
                cookies, this could affect certain features
                or services of our Services. To opt-out of
                interest-based advertising by advertisers on
                our Services visit
                http://www.aboutads.info/choices/. Opting
                out of email marketing: You can unsubscribe
                from our marketing email list at any time by
                clicking on the unsubscribe link in the
                emails that we send or by contacting us
                using the details provided below. You will
                then be removed from the marketing email
                list – however, we will still need to send
                you service-related emails that are
            ...
            {/* Privacy 11 */}
            <div>
              <h2 id="privacy11" className="mb-2 text-2xl">
                DATA BREACH
              </h2>
              <p className="text-muted-foreground mb-10">
                ...
                breaches when SciTeens Inc. believes you are
                likely to be at risk or serious harm. For
                example, a data breach may be likely to
                result in serious financial harm or harm to
                your mental or physical well-being. In the
                event that SciTeens Inc. becomes aware of a
                security breach which has resulted or may
                result in unauthorized access, use or
                disclosure of personal information SciTeens
                Inc. will promptly investigate the matter
                and notify the applicable Supervisory
            ...
            {/* Privacy 12 */}
            <div>
              <h2 id="privacy12" className="mb-2 text-2xl">
                CONTROLS FOR DO-NOT-TRACK FEATURES
              </h2>
              <p className="text-muted-foreground mb-10">
                ...
                collected. No uniform technology standard
                ...
                adopted that we must follow in the future,
                we will inform you about that practice in a
            ...
            {/* Privacy 13 */}
            <div>
              <h2 id="privacy13" className="mb-2 text-2xl">
                DO CALIFORNIA RESIDENTS HAVE SPECIFIC
                PRIVACY RIGHTS?
              </h2>
              <p className="text-muted-foreground mb-10">
                ...
                information. California Civil Code Section
                ...
                information provided below. If you are under
                18 years of age, reside in California, and
                have a registered account with the Services,
                ...
                California. We will make sure the data is
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-10">
                ...
                material changes to this privacy policy, we
                ...
                to review this privacy policy frequently to
            ...
            {/* Privacy 15 */}
            <div>
              <h2 id="privacy15" className="mb-2 text-2xl">
            ...
            {/* Privacy 16 */}
            <div>
              <h2 id="privacy16" className="mb-2 text-2xl">
