                    ...
                    <div className="w-1/4">
                        <div className="sticky top-1/2 transform -translate-y-1/2 ">
                            ...
                            <ul className="text-sm text-gray-700">
                                ...
                                <li>
                                    <a href="#privacy2" className="hover:underline">How Do We use Your Information?</a>
                                </li>
                                <li>
                                    <a href="#privacy3" className="hover:underline">Will Your Information Be Shared With
                                        Anyone?</a>
                                </li>
                                <li>
                                    <a href="#privacy4" className="hover:underline">Who Will Your Information Be Shared
                                        With?</a>
                                </li>
                                <li>
                                    <a href="#privacy5" className="hover:underline">Do We Use Cookies and Other Tracking
                                        Technologies?</a>
                                </li>
                                <li>
                                    <a href="#privacy6" className="hover:underline">Do We Use Google Maps?</a>
                                </li>
                                <li>
                                    <a href="#privacy7" className="hover:underline">How Do We Handle Your Social Logins?</a>
                                </li>
                                <li>
                                    <a href="#privacy8" className="hover:underline">How Long Do We Keep Your Information?</a>
                                </li>
                                <li>
                                    <a href="#privacy9" className="hover:underline">How Do We Keep Your Information Safe?</a>
                                </li>
                                <li>
                                    <a href="#privacy10" className="hover:underline">What Are Your Privacy Rights?</a>
                                </li>
                                <li>
                                    <a href="#privacy11" className="hover:underline">Data Breach</a>
                                </li>
                                <li>
                                    <a href="#privacy12" className="hover:underline">Controls For Do Not Track Features</a>
                                </li>
                                <li>
                                    <a href="#privacy13" className="hover:underline">Do California Residents Have Specific
                                        Privacy Rights?</a>
                                </li>
                                <li>
                                    <a href="#privacy14" className="hover:underline">Do We Make Updates To This Policy?</a>
                                </li>
                                <li>
                                    <a href="#privacy15" className="hover:underline">How Can You Review, Update, or Delete
                                        The Data We Collect From You?</a>
                                </li>
                                <li>
                                    <a href="#privacy16" className="hover:underline">How Can You Contact Us About This Policy?</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="w-2/3">
                        ...
                        <div>
                            ...
                            <p className="text-gray-700 mb-4">
                                ...
                                operation of our Services, and for our internal analytics and reporting purposes. Like many businesses,
                                we also collect information through cookies and similar technologies.
                                <br />
                                <b>Online Identifiers.</b>
                                <br />
                                We collect cookie identifiers, or others such as the ones used for analytics and marketing; and
                                other similar data.
                            </p>
                            ...
                            <p className="text-gray-700 mb-4">
                                ...
                                third parties. Examples of the information we receive from other sources include: social media profile
                                information (your name, gender, birthday, email, current city, state and country, user identification
                                numbers for your contacts, profile picture URL, and any other information that you choose to make public);
                                marketing leads and search results and links, including paid listings (such as sponsored links). We
                                will inform you about the source of information and the type of information and the type of information
                                we have collected about you within a reasonable period after obtaining the personal data, but at the
                        ...
                        {/* Privacy 2 */}
                        <div>
                            <h2 id="privacy2" className="text-2xl mb-2">HOW DO WE USE YOUR INFORMATION?</h2>
                            <p className="text-gray-700 mb-4">
                                ...
                                consent. We use personal information collected via our Services for a variety of business
                                purposes described below. We process your personal information for these purposes in reliance
                                on our legitimate business interests, in order to enter into or perform a contract with you,
                                with your consent, and/or for compliance with our legal obligations. We indicate the specific
                            ...
                            <ul className="list-inside list-decimal text-gray-700 mb-4 ml-4">
                                ...
                                <li>
                                    ...
                                    our promotional campaigns and to evaluate and improve our Services, products, marketing
                                    and your experience. We may use and store this information in aggregated and anonymized
                                    form so that it is not associated with individual end users and does not include
                        ...
                        {/* Privacy 3 */}
                        <div>
                            <h2 id="privacy3" className="text-2xl mb-2">WILL YOUR INFORMATION BE SHARED WITH ANYONE?</h2>
                            <p className="text-gray-700 mb-4">
                                In Short: We only share information with your consent, to comply with laws, to provide you
                                with services, to protect your rights, or to fulfill business obligations. We may process
                            ...
                            <ul className="list-inside list-decimal text-gray-700 mb-4 ml-4">
                                <li>
                                    ...
                                    for us or on our behalf and require access to such information to do that work. Examples
                                    ...
                                    technology on the Services, which will enable them to collect data about how you interact
                                    with the Services over time. This information may be used to, among other things, analyze
                                    and track data, determine the popularity of certain content and better understand online
                                    activity. Unless described in this Policy, we do not share, sell, rent or trade any of
                                    your information with third parties for their promotional purposes. We have contracts in
                                    place with our data processors. This means that they cannot do anything with your personal
                                ...
                                <li>
                                    ...
                                    contributions or other content to the Services) or otherwise interact with public
                                    areas of the Services, such personal information may be viewed by all users and may
                                    be publicly distributed outside the Services in perpetuity. If you interact with
                                    other users of our Services and register through a social network (such as Facebook),
                                    your contacts on the social network will see your name, profile photo, and descriptions
                        ...
                        {/* Privacy 4 */}
                        <div>
                            <h2 id="privacy4" className="text-2xl mb-2">WHO WILL YOUR INFORMATION BE SHARED WITH?</h2>
                            <p className="text-gray-700 mb-4">
                                In Short: We only share information with the following third parties. We only share
                                and disclose your information with the following third parties. We have categorized
                            ...
                            <ul className="list-inside list-decimal text-gray-700 mb-4 ml-4">
                                ...
                                <li>
                                    ...
                                    Cloud Firestore, Firebase Realtime Database , Firebase Hosting and Cloud Storage for Firebase
                                </li>
                                <li>
                        ...
                        <div>
                            ...
                            <p className="text-gray-700 mb-4">
                                ...
                                Maps APIs Terms of Service at <a href="https://cloud.google.com/maps-platform/terms"
                                    target="_blank" rel="noopener noreferrer">https://cloud.google.com/maps-platform/terms</a>
                                To better understand Google’s Privacy Policy, please refer to <a
                                    href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">
                                    https://policies.google.com/privacy</a> By using our Maps API Implementation, you agree to
                                be bound by Google’s Terms of Service.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-gray-700 mb-4">
                                ...
                                or Twitter logins). Where you choose to do this, we will receive certain profile information
                                about you from your social media provider. The profile Information we receive may vary
                                depending on the social media provider concerned, but will often include your name, e-mail
                                address, friends list, profile picture as well as other information you choose to make public.
                                We will use the information we receive only for the purposes that are described in this
                                privacy policy or that are otherwise made clear to you on the Services. Please note that we
                        ...
                        <div>
                            ...
                            <p className="text-gray-700 mb-4">
                                ...
                                information for longer than the period of time in which users have an account with us. When
                                we have no ongoing legitimate business need to process your personal information, we will
                        ...
                        {/* Privacy 10 */}
                        <div>
                            <h2 id="privacy10" className="text-2xl mb-2">WHAT ARE YOUR PRIVACY RIGHTS?</h2>
                            <p className="text-gray-700 mb-4">
                                ...
                                http://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm. If you have
                                questions or comments about your privacy rights, you may email us at support@sciteens.org.
                            </p>
                            <p className="text-lg mb-2">Account Information</p>
                            ...
                            <p className="text-gray-700 mb-4">
                                ...
                                Use and/or comply with legal requirements. Cookies and similar technologies: Most Web browsers
                                ...
                                will still need to send you service-related emails that are necessary for the administration
                                and use of your account. To otherwise opt-out, you may contact us using the contact information
                                provided.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-gray-700 mb-4">
                                ...
                                be likely to result in serious financial harm or harm to your mental or physical well-being.
                                In the event that SciTeens Inc. becomes aware of a security breach which has resulted or may
                                result in unauthorized access, use or disclosure of personal information SciTeens Inc. will
                                promptly investigate the matter and notify the applicable Supervisory Authority not later
                                than 72 hours after having become aware of it, unless the personal data breach is unlikely
                        ...
                        <div>
                            ...
                            <p className="text-gray-700 mb-4">
                                ...
                                us, once a year and free of charge, information about categories of personal information (if any)
                                we disclosed to third parties for direct marketing purposes and the names and addresses of all
                                ...
                                your request in writing to us using the contact information provided below. If you are under
                                18 years of age, reside in California, and have a registered account with the Services, you have
                        ...
                        <div>
                            ...
                            <p className="text-gray-700 mb-4">
                                ...
                                emailing support@sciteens.org. We will respond to your request within 30 days.
                            </p>
                        </div>

                        {/* Privacy 16 */}
                        <div>
                            <h2 id="privacy16" className="text-2xl mb-2">HOW CAN YOU CONTACT US ABOUT THIS POLICY?</h2>
                            <p className="text-gray-700 mb-4">
                                If you have questions or comments about this policy, you may contact our Data Protection
                                Officer (DPO), John Sutor, by email at john@sciteens.org, or by post to:
                            </p>
