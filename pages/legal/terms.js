          ...
          <div className="mx-8 md:mx-12 lg:mx-0 lg:w-2/3">
            ...
            <div>
              ...
              <p className="mb-10 text-gray-700">
                ...
                locations do so on their own initiative and
                are solely responsible for compliance with
                local laws, if and to the extent local laws
                are applicable. The Site is not tailored to
                comply with industry-specific regulations
                (Health Insurance Portability and
                Accountability Act (HIPAA), Federal
                Information Security Management Act (FISMA),
                etc.), so if your interactions would be
                subjected to such laws, you may not use this
                Site. You may not use the Site in a way that
                would violate the Gramm-Leach-Bliley Act
                (GLBA). The Site is intended for users who
                are at least 13 years of age. All users who
                ...
                supervised by, their parent or guardian to
                use the Site. If you are a minor, you must
                have your parent or guardian read and agree
                to these Terms of Use prior to you using the
                Site.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mb-10 text-gray-700">
                ...
                prior written permission. Provided that you
                are eligible to use the Site, you are
                granted a limited license to access and use
                the Site and to download or print a copy of
                any portion of the Content to which you have
                properly gained access solely for your
                personal, non-commercial use. We reserve all
                rights not expressly granted to you in and
            ...
            <div>
              ...
              <ul className="mb-10 ml-4 list-inside list-decimal text-gray-700">
                ...
                <li>
                  ...
                  applicable law or regulation. If you
                  provide any information that is untrue,
                  inaccurate, not current, or incomplete, we
                  have the right to suspend or terminate
                  your account and refuse any and all
                  current or future use of the Site (or any
                  portion thereof).
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="mb-4 ml-4 list-inside list-decimal text-gray-700">
                ...
                <li>
                  ...
                  incite, encourage, or threaten physical
            ...
            <div>
              ...
              <p className="mb-10 text-gray-700">
                ...
                and through any media channels. This license
                will apply to any form, media, or technology
                now known or hereafter developed, and
                includes our use of your name, company name,
                and franchise name, as applicable, and any
                of the trademarks, service marks, trade
                ...
                been asserted in your Contributions. We do
                not assert any ownership over your
                ...
                Contributions. We have the right, in our
                sole and absolute discretion, (1) to edit,
                redact, or otherwise change any
            ...
            <div>
              ...
              <ul className="mb-10 ml-4 list-inside list-decimal text-gray-700">
                ...
                <li>
                  ...
                  the extent technologically feasible) any
                  of your Contributions or any portion
                  thereof.
                </li>
                <li>
                  In our sole discretion and without
                  limitation, notice, or liability, to
                  remove from the Site or otherwise disable
                  all files and content that are excessive
                  in size or are in any way burdensome to
                  our systems.
                </li>
                <li>
            ...
            <div>
              ...
              <p className="mb-10 text-gray-700">
                ...
                Site is hosted in the United States. If you
                access the Site from any other region of the
                world with laws or other requirements
                governing personal data collection, use, or
                disclosure that differ from applicable laws
                in the United States, then through your
                continued use of the Site, you are
                ...
                Children’s Online Privacy Protection Act, if
                we receive actual knowledge that anyone
                under the age of 13 has provided personal
                information to us without the requisite and
                verifiable parental consent, we will delete
                that information from the Site as quickly as
            ...
            <div>
              ...
              <p className="mb-10 text-gray-700">
                ...
                of the Site. We cannot guarantee the Site
                ...
                interruptions, delays, or errors. We reserve
                the right to change, revise, update,
                suspend, discontinue, or otherwise modify
                ...
                inability to access or use the Site during
            ...
            <div>
              ...
              <p className="mb-10 text-gray-700">
                ...
                Florida, without regard to its conflict of
                law principles.
              </p>
            </div>
            ...
            {/* Term 16 */}
            <div>
              <h2 id="term16" className="mb-2 text-2xl">
                DISPUTE RESOLUTION
              </h2>
              ...
              <p className="mb-6 text-gray-700">
                ...
                excluded below) will be finally and
                exclusively resolved through binding
                arbitration. YOU UNDERSTAND THAT WITHOUT
                THIS PROVISION, YOU WOULD HAVE THE RIGHT TO
                ...
                either Party related in any way to the Site
                be commenced more than one (1) years after
                the cause of action arose. If this provision
                is found to be illegal or unenforceable,
                then neither Party will elect to arbitrate
                any Dispute falling within that portion of
              ...
              <p className="mb-10 text-gray-700">
                ...
                and binding arbitration: (a) any Disputes
                seeking to enforce or protect, or concerning
                the validity of, any of the intellectual
            ...
            <div>
              ...
              <p className="mb-10 text-gray-700">
                ...
                US OR $50.00 USD. CERTAIN US STATE LAWS AND
            ...
            <div>
              ...
              <p className="mb-10 text-gray-700">
                ...
                for which you are required to indemnify us,
                and you agree to cooperate, at your expense,
                with our defense of such claims. We will use
            ...
            {/* Term 22 */}
            <div>
              <h2 id="term22" className="mb-2 text-2xl">
