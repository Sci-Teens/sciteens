...
function Banner({ closeBanner }) {
    ...
    return (
        banner?.data.show_banner ?
            <div className="relative w-full h-32 lg:h-12 mx-auto text-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white textl-lg flex flex-row items-center justify-center">
