...
function FieldLabel({ className, ...props }) {
  return (
    <Label
      ...
      className={cn(
        'group/field-label peer/field-label group-data-[disabled=true]/field:opacity-50 has-data-checked:border-primary/30 has-data-checked:bg-primary/5 has-[>[data-slot=field]]:rounded-lg has-[>[data-slot=field]]:border *:data-[slot=field]:p-2.5 flex w-fit gap-2 leading-snug',
